...
namespace LearningCentre.Infra.Domain.Migrations
{
    ...
    [Migration("20230327043710_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearningCentre.Infra.Domain.Entities.AssignTask", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AssignTaskId"));
            ...
            modelBuilder.Entity("LearningCentre.Infra.Domain.Entities.Tasks", b =>
                {
                    b.Property<int>("TaskId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LearningCentre.Infra.Domain.Entities.UserTaskSubmit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserTaskSubmits");
                });

            modelBuilder.Entity("LearningCentre.Infra.Domain.Entities.AssignTask", b =>
                {
                    b.HasOne("LearningCentre.Infra.Domain.Entities.Tasks", null)
                        .WithMany("AssignTask")
            ...
            modelBuilder.Entity("LearningCentre.Infra.Domain.Entities.User", b =>
                {
                    b.HasOne("LearningCentre.Infra.Domain.Entities.Technology", null)
                        .WithMany("User")
