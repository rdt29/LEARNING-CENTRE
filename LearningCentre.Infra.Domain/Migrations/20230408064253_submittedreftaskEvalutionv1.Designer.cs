...
namespace LearningCentre.Infra.Domain.Migrations
{
    ...
    [Migration("20230408064253_submittedreftaskEvalutionv1")]
    partial class submittedreftaskEvalutionv1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearningCentre.Infra.Domain.Entities.TaskEvaluation", b =>
                {
                    ...
                    b.Property<int>("SubmittedTaskId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LearningCentre.Infra.Domain.Entities.TaskEvaluation", b =>
                {
                    b.HasOne("LearningCentre.Infra.Domain.Entities.SubmittedTasks", "SubmittedTask")
                        .WithOne("TaskEvaluation")
                        .HasForeignKey("LearningCentre.Infra.Domain.Entities.TaskEvaluation", "SubmittedTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LearningCentre.Infra.Domain.Entities.User", b =>
                {
                    b.HasOne("LearningCentre.Infra.Domain.Entities.User", "users")
                        .WithMany()
